...
class PreferencesDialog(QtWidgets.QDialog):
    ...
    def _create_performance_tab(self):
        ...
        self._perf_monitoring_check = QtWidgets.QCheckBox("Enable performance monitoring")
    ...
    def _load_settings(self):
        ...
        parallel_workers = self._settings.value("performance/parallel_workers", 4, type=int)
        ...
        perf_monitoring = self._settings.value("performance/monitoring_enabled", True, type=bool)
        self._perf_monitoring_check.setChecked(perf_monitoring)
        
        auto_refresh = self._settings.value("performance/auto_refresh_seconds", 2, type=int)
        ...
        default_thumb_size = self._settings.value("ui/default_thumbnail_size", 512, type=int)
    ...
    def _save_and_accept(self):
        ...
        self._settings.setValue("cache/max_thumbnail_mb", self._max_thumb_cache_spin.value())
        ...
        # Performance settings
        self._settings.setValue("performance/parallel_workers", self._parallel_workers_spin.value())
        self._settings.setValue("performance/tile_size", int(self._tile_size_combo.currentText()))
        self._settings.setValue("performance/monitoring_enabled", self._perf_monitoring_check.isChecked())
        self._settings.setValue("performance/auto_refresh_seconds", self._auto_refresh_spin.value())
        
        # UI settings
        self._settings.setValue("ui/show_tooltips", self._show_tooltips_check.isChecked())
        self._settings.setValue("ui/show_statusbar", self._show_statusbar_check.isChecked())
        self._settings.setValue("ui/confirm_close", self._confirm_close_check.isChecked())
        self._settings.setValue("ui/recent_files_count", self._recent_files_spin.value())
        self._settings.setValue("ui/default_thumbnail_size", self._default_thumb_size_spin.value())
